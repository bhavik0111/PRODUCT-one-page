...
$file ="";
	...
	if (isset($_POST["submit"])) 
	{
		  ...
		  {
		    $_SESSION['error']['category_id_error'] = "Please enter category_id";
		  }
		  ...
		  {
		    $_SESSION['error']['status_error'] = "Please enter status";
		  }
...
?>
	  ...
	  <body>
		...
		<tr>
		  <th>name</th>
		  <td><input type="text" name="name" value="<?php echo $name; ?>" id="">
		...
		<tr>
		  <th>price</th>
		  <td><input type="price" name="price">
